...
CREATE TABLE `core_materials` (
  ...
  `thickness_mm` decimal(4,1) DEFAULT NULL,
  PRIMARY KEY (`core_id`)
...
LOCK TABLES `core_materials` WRITE;
/*!40000 ALTER TABLE `core_materials` DISABLE KEYS */;
INSERT INTO `core_materials` VALUES (1,'Polymer 16',16.0),(2,'Polymer 14',14.0),(3,'Polymer 13',13.0),(4,'Polymer 12',12.0),(5,'Nomex',14.0),(6,'Aluminum',14.0),(7,'SST Carbon',11.0),(8,'Kevlar',16.0),(9,'EVA Foam',20.0),(10,'Wood',10.0);
